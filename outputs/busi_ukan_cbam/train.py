...
def main():
    ...
    if dataset_name == 'busi':
        ...
        # 默认使用 .png (适用于 BUSI_processed 等自定义数据集)
        mask_ext = '.png'
    ...
    for epoch in range(start_epoch, config['epochs']):
        ...
        # 保存 checkpoint 用于断点续训（每个 epoch 都保存）
        checkpoint = {
            'epoch': epoch,
        ...
        torch.save(checkpoint, f'{output_dir}/{exp_name}/checkpoint.pth')
